...
public abstract class ObdCommand {
    ...
    /**
     * Sends the OBD-II request and deals with the response. <p/> This method CAN be overriden in
     * fake commands.
     *
    ...
    /**
     * Sends the OBD-II request. <p/> This method may be overriden in subclasses, such as
     * ObMultiCommand or TroubleCodesCommand.
     *
    ...
    /**
     * Reads the OBD-II response. <p/> This method may be overriden in subclasses, such as
     * ObdMultiCommand.
     *
     * @param in a {@link java.io.InputStream} object.
     * @throws java.io.IOException if any.
    ...
    /**
     * This method exists so that for each command, there must be a method that is called only once
    ...
    /**
     * Set to 'true' if you want to use imperial units, false otherwise. By default this value is
     * set to 'false'.
     *
